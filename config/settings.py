...
DEVICE_IP = env('DEVICE_IP',None)
HIKVISION_USERNAME = env('USERNAME',None)
HIKVISION_PASSWORD = env('PASSWORD',None)
NEW_HRM_BASE_URL = env('NEW_HRM_BASE_URL',None)
...
MIDDLEWARE = [
    ...
    # 'config.middleware.ip_restriction.ip_restriction_middleware'
]
