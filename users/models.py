...
class User(AbstractUser):
    ...
    personal_email = models.EmailField(max_length=200,null=True,blank=True)
    ...
    joining_designation = models.CharField(max_length=200,null=True,blank=True)
    ...
    joining_time_salary = models.CharField(max_length=250,null=True,blank=True)
...
class Role(models.Model):
    ...
    employee_add_access = models.BooleanField(default=False)
    ...
    ip_add_access = models.BooleanField(default=False)
    ...
    role_add_access = models.BooleanField(default=False)
    ...
    applicant_add_access = models.BooleanField(default=False)
    created_at = models.DateTimeField(auto_now_add=True)
